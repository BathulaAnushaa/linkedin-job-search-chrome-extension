...
> ⚠️ **WARNING: Max speed (0x delay) is NOT recommended.**
>
> It removes all delays between actions, which can:
>
...
| **Collapsible Sidebar** | Toggle the preferences sidebar with the ◀️ / ▶️ buttons |
...
If the page is reloaded while scraping, the extension saves the current
phase, query index, and URL. On the next page load, it automatically
